...
export default class NPCManager {
  ...
  private npcConfigs: NPCConfig[] = [
    ...
    },
    {
      ...
      name: 'Mr. Rug Pull',
      class: MrRugPull,
      position: { x: 150, y: 200 }, // Updated position as requested
      interactionRange: 100
    },
    {
      id: 'artizengent',
      name: 'Artizen Gent',
      class: ArtizenGent,
      position: { x: 1480, y: 200 }, // Add a reasonable position for Artizen Gent
      interactionRange: 100
    },
    {
      id: 'thirdwebguy',
      name: '3RDWeb Guy',
      class: ThirdWebGuy,
      position: { x: 1430, y: 760 }, // Position for ThirdWeb Guy
      interactionRange: 100
    },
    {
      id: 'alchemyman',
